...
function renderResults(container) {
  ...
  container.innerHTML = `
    ...
    <div class="result" id="modulo-feedback" style="padding: 13.5px; display: flex; flex-direction: column; align-items:center;">
      ...
      <textarea id="commento-feedback" placeholder="Cosa possiamo migliorare?" style="font-style: normal; font-size: 20px; margin: 15px; max-width: 100%; resize: none; width: 320px; height: 100px; border-radius:12px;"></textarea>
